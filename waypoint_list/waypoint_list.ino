...
void loop() {
  ...
  if (recebido){
    ...
    distancia_entre = gps1.distance_between(average_lat, average_lon, waypoints[0][0], waypoints[0][1]);
    Serial.print("       Distancia até Waypoint: ");
    Serial.println(distancia_entre, 2);
    //azimuth
    float curso; //course_to == azimuth 
    curso = gps1.course_to(average_lat, average_lon, waypoints[0][0], waypoints[0][1]);
